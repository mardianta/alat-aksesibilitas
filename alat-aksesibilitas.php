 ...
 * Status: Stable
 * Version: 1.1.0
 * Author: <a href="https://github.com/mardianta/alat-aksesibilitas">Alat Aksesibilitas</a> | <a href="#" class="thickbox open-plugin-details-modal" aria-label="More information about Alat Aksesibilitas" data-title="Alat Aksesibilitas">View details</a>
...
function enqueue_accessibility_scripts()
{
  ...
  wp_enqueue_style('alat-aksesibilitas-style', plugin_dir_url(__FILE__) . 'css/alat-aksesibilitas.css');
  wp_enqueue_script('alat-aksesibilitas-script', plugin_dir_url(__FILE__) . 'js/alat-aksesibilitas.js', array('jquery'), '1.0', true);
}
...
{
  include(plugin_dir_path(__FILE__) . 'assets/toolbar.php');
}
